...
export function EnergyBreakdown({ result, highlightedItems = [], feedbackToken = 0 }: { result: Pick<SimulationResult, "dailyEnergyKWh" | "hvacEnergyKWh" | "deviceEnergyKWh" | "lightingEnergyKWh">; highlightedItems?: BreakdownCategory[]; feedbackToken?: number }) {
