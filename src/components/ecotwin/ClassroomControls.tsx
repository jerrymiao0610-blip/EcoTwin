...
export function ClassroomControls({ config, onChange, onReset, contextNote, weatherContext, weatherLoading, weatherLocation, onWeatherRefresh }: Props) {
